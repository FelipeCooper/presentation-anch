Break down a PRD + Tech Spec into an actionable task list
...
<critical>DO NOT IMPLEMENT ANYTHING, THE FOCUS OF THIS STAGE IS ON THE LIST AND DETAILING OF TASKS</critical>
